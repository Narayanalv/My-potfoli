                ...
                <Row className="align-items-center min-vh-100 text-center">
                    <Col md={{ span: 8, offset: 2 }}>
                        ...
                        <div className="d-flex gap-3 justify-content-center">
                            <Button href="/My-potfoli/#/projects" variant="primary" size="lg" className="px-4 py-2 rounded-pill fw-semibold shadow" style={{ background: 'var(--accent-gradient)', border: 'none' }}>
                                View My Work
                            </Button>
